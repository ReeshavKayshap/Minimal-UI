  ...
  return (
    <section className="relative w-full py-40">
      ...
      <div className="relative z-10 mx-auto max-w-336  flex flex-col w-full gap-8">
        ...
        py-1.5 rounded-full group px-5 cursor-pointer z-30 gap-1"
          initial="inital"
          whileHover="show"
        >
          <span className="text-neutral-400  group-hover:text-neutral-300 transition-all duration-300 font-geist text-sm ">
        ...
        <div className="flex flex-col gap-6 ">
          <h1 className="text-white z-20 bg-clip-text text-[80px] leading-[1.1] font-inter font-bold  ">
            Beautiful UI components <br /> with minimal interaction.
          </h1>
          <p className="text-neutral-300/90 text-xl z-20 max-w-3xl tracking-wide">
        ...
        <div className="flex gap-4 z-30">
          <button
            className="text-black bg-neutral-200 backdrop-blur-md cursor-pointer border border-neutral-700
