function ShowCast() {
  return (
    <div
      className="flex flex-col py-60 px-10 relative gap-8  
     w-full "
    >
      ...
      <div className="grid grid-cols-4 grid-rows-[auto_auto] gap-2 ">
        <div className=" bg-amber-200 h-140 w-full rounded-2xl row-span-2"></div>
        <div className=" bg-amber-300 h-80 w-full col-span-1 rounded-2xl"></div>
        <div
          className="rounded-2xl bg-neutral-900 col-span-2 w-full h-80 
        ...
        <div className=" bg-amber-500 h-58 w-full col-span-3 rounded-2xl "></div>
      </div>
    </div>
  );
}
