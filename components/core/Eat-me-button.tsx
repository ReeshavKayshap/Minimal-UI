  ...
  return (
    <motion.div
      ...
      style={{
        ...
        backgroundColor:
          particle.kind === "fill" ? particleColor : "transparent",
        border:
          particle.kind === "stroke" ? `2px solid ${particleColor}` : "none",
        borderRadius: "50%",
...
export function EatMeButton({
  ...
  return (
    <div
      className={cn(
        " flex items-center justify-center overflow-visible select-none  w-full",
        className,
      )}
    >
      <div
